...
const styles = StyleSheet.create({
  ...
  myUploadsPill: { borderWidth: 1, borderColor: '#444', borderRadius: 20, paddingHorizontal: 12, paddingVertical: 5 },
  myUploadsPillActive: { backgroundColor: Colors.accent, borderColor: Colors.accent },
  myUploadsPillText: { fontSize: 12, fontWeight: '600', color: '#666' },
